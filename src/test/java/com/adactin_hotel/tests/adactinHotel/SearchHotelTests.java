...
import com.adactin_hotel.dataProviders.BookingTestDataProviders;
...
public class SearchHotelTests extends TestBase {
    ...
    @Test(groups = {"sanity"}, retryAnalyzer = TestRetryAnalyzer.class, dataProvider = "locations", dataProviderClass = BookingTestDataProviders.class)
    ...
    @Test(groups = {"sanity"}, retryAnalyzer = TestRetryAnalyzer.class, dataProvider = "hotels", dataProviderClass = BookingTestDataProviders.class)
    ...
    @Test(groups = {"sanity"}, retryAnalyzer = TestRetryAnalyzer.class, dataProvider = "roomTypes", dataProviderClass = BookingTestDataProviders.class)
    ...
    @Test(groups = {"sanity"}, dataProvider = "numberOfRooms", dataProviderClass = BookingTestDataProviders.class)
    ...
    @Test(groups = {"sanity"}, retryAnalyzer = TestRetryAnalyzer.class, dataProvider = "adultsPerRoom", dataProviderClass = BookingTestDataProviders.class)
    ...
    @Test(groups = {"sanity"}, retryAnalyzer = TestRetryAnalyzer.class, dataProvider = "childrenPerRoom", dataProviderClass = BookingTestDataProviders.class)
