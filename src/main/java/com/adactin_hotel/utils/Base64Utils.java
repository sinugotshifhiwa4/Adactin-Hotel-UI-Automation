...
import static com.adactin_hotel.crypto.utils.InputValidator.validateInput;
...
public final class Base64Utils {
    ...
    public static SecretKey decodeSecretKey(String encodedKey) {
        ...
        try {
            ...
            return new SecretKeySpec(decodedKey, CryptoAlgorithmTypes.AES.getAlgorithmName());
        } catch (Exception error) {
